...
print("""
    ...
    $$ | $\\  $$ |          $$ |                                                    $$ |                      $$ |    $$ |                                                                                                            $$ |                  $$ |                                           $$ |           $$ |                        
    $$ |$$$\\ $$ | $$$$$$\\  $$ | $$$$$$$\\  $$$$$$\\  $$$$$$\\$$$$\\   $$$$$$\\        $$$$$$\\    $$$$$$\\        $$$$$$\\   $$$$$$$\\   $$$$$$\\        $$$$$$\\$$$$\\   $$$$$$\\   $$$$$$\\   $$$$$$$\\  $$$$$$\\         $$$$$$$\\  $$$$$$\\   $$$$$$$ | $$$$$$\\        $$$$$$\\    $$$$$$\\  $$$$$$\\  $$$$$$$\\   $$$$$$$\\ $$ | $$$$$$\\ $$$$$$\\    $$$$$$\\   $$$$$$\\  
    $$ $$ $$\\$$ |$$  __$$\\ $$ |$$  _____|$$  __$$\\ $$  _$$  _$$\\ $$  __$$\\       \\_$$  _|  $$  __$$\\       \\_$$  _|  $$  __$$\\ $$  __$$\\       $$  _$$  _$$\\ $$  __$$\\ $$  __$$\\ $$  _____|$$  __$$\\       $$  _____|$$  __$$\\ $$  __$$ |$$  __$$\\       \\_$$  _|  $$  __$$\\ \\____$$\\ $$  __$$\\ $$  _____|$$ | \\____$$\\\\_$$  _|  $$  __$$\\ $$  __$$\\ 
    $$$$  _$$$$ |$$$$$$$$ |$$ |$$ /      $$ /  $$ |$$ / $$ / $$ |$$$$$$$$ |        $$ |    $$ /  $$ |        $$ |    $$ |  $$ |$$$$$$$$ |      $$ / $$ / $$ |$$ /  $$ |$$ |  \\__|\\$$$$$$\\  $$$$$$$$ |      $$ /      $$ /  $$ |$$ /  $$ |$$$$$$$$ |        $$ |    $$ |  \\__|$$$$$$$ |$$ |  $$ |\\$$$$$$\\  $$ | $$$$$$$ | $$ |    $$ /  $$ |$$ |  \\__|
    $$$  / \\$$$ |$$   ____|$$ |$$ |      $$ |  $$ |$$ | $$ | $$ |$$   ____|        $$ |$$\\ $$ |  $$ |        $$ |$$\\ $$ |  $$ |$$   ____|      $$ | $$ | $$ |$$ |  $$ |$$ |       \\____$$\\ $$   ____|      $$ |      $$ |  $$ |$$ |  $$ |$$   ____|        $$ |$$\\ $$ |     $$  __$$ |$$ |  $$ | \\____$$\\ $$ |$$  __$$ | $$ |$$\\ $$ |  $$ |$$ |      
    $$  /   \\$$ |\\$$$$$$$\\ $$ |\\$$$$$$$\\ \\$$$$$$  |$$ | $$ | $$ |\\$$$$$$$\\         \\$$$$  |\\$$$$$$  |        \\$$$$  |$$ |  $$ |\\$$$$$$$\\       $$ | $$ | $$ |\\$$$$$$  |$$ |      $$$$$$$  |\\$$$$$$$\\       \\$$$$$$$\\ \\$$$$$$  |\\$$$$$$$ |\\$$$$$$$\\         \\$$$$  |$$ |     \\$$$$$$$ |$$ |  $$ |$$$$$$$  |$$ |\\$$$$$$$ | \\$$$$  |\\$$$$$$  |$$ |$$\\   
    \\__/     \\__| \\_______|\\__| \\_______| \\______/ \\__| \\__| \\__| \\_______|         \\____/  \\______/          \\____/ \\__|  \\__| \\_______|      \\__| \\__| \\__| \\______/ \\__|      \\_______/  \\_______|       \\_______| \\______/  \\_______| \\_______|         \\____/ \\__|      \\_______|\\__|  \\__|\\_______/ \\__| \\_______|  \\____/  \\______/ \\__|\\__|
    """)
...
while True:
    ...
    # If no error is raised, the program continues to the translator depending on the user's choice
        ...
        if choice == '1':
            ...
            print('''
                 _____          _     _                                        
                /__   \\_____  _| |_  | |_ ___    _ __ ___   ___  _ __ ___  ___ 
                  / /\\/ _ \\ \\/ / __| | __/ _ \\  | '_ ` _ \\ / _ \\| '__/ __|/ _ \\
                 / / |  __/>  <| |_  | || (_) | | | | | | | (_) | |  \\__ \\  __/
                 \\/   \\___/_/\\_\\\\__|  \\__\\___/  |_| |_| |_|\\___/|_|  |___/\\___|
                ''')
        ...
        # START morse to text translator
            ...
            print('''
                    __  ___                        __           __            __ 
                   /  |/  /___  _____________     / /_____     / /____  _  __/ /_
                  / /|_/ / __ \\/ ___/ ___/ _ \\   / __/ __ \\   / __/ _ \\| |/_/ __/
                 / /  / / /_/ / /  (__  )  __/  / /_/ /_/ /  / /_/  __/>  </ /_  
                /_/  /_/\\____/_/  /____/\\___/   \\__/\\____/   \\__/\\___/_/|_|\\__/  
                ''')
